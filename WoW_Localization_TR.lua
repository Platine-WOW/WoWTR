-- Addon: WoWTR (version: 10.L10) 2024.01.30
...
WoWTR_Localization = {
   ...
   WoWTR_Spellbook_trDESC = "Büyü Kitabı: Türkçe",                   -- Spell Book: Turkish
...
QTR_Messages = {   
   ...
   itemchoose1= "Bu ödüllerden birini seçebileceksiniz:",  -- Możesz wybrać jedną z nagród: (You will be able to choose one of these rewards:) 
   itemchoose2= "Bu ödüllerden birini seçin:",             -- Wybierz jedną z nagród: (Choose one of these rewards:) 
   itemchoose3= "Ödülü alıyorsunuz:",                      -- Otrzymujesz nagrodę: (You receiving the reward:) 
   itemreceiv0= "Alacaksınız:",                            -- Otrzymasz: (You will receive:) 
   itemreceiv1= "Ayrıca şunları alacaksınız:",             -- Otrzymasz również: (You will also receive:) 
   itemreceiv2= "Ödülü alıyorsunuz:",                      -- Otrzymujesz nagrodę: (You receiving the reward:) 
   itemreceiv3= "Ayrıca ödülü alıyorsunuz:",               -- Otrzymujesz również nagrodę: (You also receiving the reward:) 
   ...
   reward_aura      = "Aşağıdakiler size verilecektir:",   -- Otrzymasz efekt: (The following will be cast on you:) 
   reward_spell     = "Aşağıdakileri öğreneceksiniz:",     -- Nauczysz się: (You will learn the following:) 
   reward_companion = "Bu Companionları kazanacaksınız:",  -- Zyskasz towarzyszy: (You will gain these Companions:) 
   reward_follower  = "Bu takipçileri kazanacaksınız:",    -- Zyskasz zwolenników: (You will gain these followers:) 
   reward_reputation= "İtibar ödülleri:",                  -- Wzrost reputacji: (Reputation awards:) 
   reward_title     = "Size unvan verilecektir:",          -- Otrzymasz tytuł: (You shall be granted the title:) 
   reward_tradeskill= "Nasıl oluşturulacağını öğreneceksiniz:",        -- Nauczysz się wytwarzania: (You will learn how to create:) 
   reward_unlock    = "Aşağıdakilere erişimin kilidini açacaksınız:",  -- Odblokujesz: (You will unlock access to the following:) 
...
WoWTR_Config_Interface = {
   ...
   setDungeonFrames = "Konuşma balonu pencerelerini ayarlama",                                        -- Set up speech bubble frames
   ...
   saveUntranslatedBubbles = "Çevirisi olmayan baloncuk konuşmaları kaydet",                          -- Save untranslated bubbles (TR:Çevirisi olmayan baloncuk konuşmaları kaydet)
   ...
   fontSelectingFontHeader = "EK YAZI TİPİNİ SEÇME",                                                  -- Selecting the add-on font
   ...
   activateTooltipTranslationsDESC = "Etkinleştirilirse, çevrilmiş araç ipuçları görüntülenecektir",  -- If enabled, translated tooltips will displayed (TR:Etkinleştirilirse, çevrilmiş araç ipuçları görüntülenecektir)
   translateItems = "Öğeler için çevrilmiş araç ipuçlarını göster",                                   -- Display translated tooltips for items (TR:Öğeler için çevrilmiş araç ipuçlarını göster)
   translateItemsDESC = "Etkinleştirilirse, öğeler için çevrilmiş araç ipuçları görüntülenecektir",   -- If enabled, translated tooltips for items will be displayed (TR:Etkinleştirilirse, öğeler için çevrilmiş araç ipuçları görüntülenecektir)
   translateSpells = "Büyüler için çevrilmiş araç ipuçlarını göster",                                 -- Display translated tooltips for spells (TR:Büyüler için çevrilmiş araç ipuçlarını göster)
   translateSpellsDESC = "Etkinleştirilirse, büyüler için çevrilmiş araç ipuçları görüntülenecektir", -- If enabled, translated tooltips for spells will be displayed (TR:Etkinleştirilirse, büyüler için çevrilmiş araç ipuçları görüntülenecektir)
   translateTalents = "Yetenekler için çevrilmiş araç ipuçlarını göster",                             -- Display translated tooltips for talents (TR:Yetenekler için çevrilmiş araç ipuçlarını göster)
   translateTalentsDESC = "Etkinleştirilirse, yetenekler için çevrilmiş araç ipuçları görüntülenecektir",   -- If enabled, translated tooltips for talents will be displayed (TR:Etkinleştirilirse, yetenekler için çevrilmiş araç ipuçları görüntülenecektir)
   translateTooltipTitle = "Araç ipuçlarının çevrilmiş başlığını göster",                             -- Display translated title of item, spell or talent
   ...
   showTooltipIDDESC = "Etkinleştirilirse, araç ipuçları kimliğini göster",                           -- If enabled, display tooltips ID (TR:Etkinleştirilirse, araç ipuçları kimliğini göster)
   ...
   teamHeader = "WoWTR",                                                                              -- WoWTR project team (TR:WoWTR)
   textContact = "Eklentiyle ilgili herhangi bir sorunuz varsa lütfen aşağıdaki kanallardan herhangi birinden bizimle iletişime geçin:",
   linkWWWShow = "Eklentinin web sayfasının bağlantısını görüntülemek için tıklayın",
   linkWWWTitle = "Web sitesine bağlantı",
   linkDISCShow = "Discord sayfasının bağlantısını görüntülemek için tıklayın",
   linkDISCTitle = "Discord sayfasına bağlantı",
   linkEMAILShow = "Proje e-posta adresini görüntülemek için tıklayın",
   linkEMAILTitle = "Proje e-posta adresi",
   linkCURSEShow = "CurseForge web sitesinin bağlantısını görüntülemek için tıklayın",
   linkCURSETitle = "CurseForge web sitesine bağlantı",
   linkPPShow = "PayPal web sitesinin bağlantısını görüntülemek için tıklayın",
   linkPPTitle = "PayPal web sitesine bağlantı",
   linkBLIKShow = "BLIK telefon numarasını görüntülemek için tıklayın",
   linkBLIKTitle = "BLİK telefon numarası",
   linkTWITCHShow = "Twitch sayfasının bağlantısını görüntülemek için tıklayın",
   linkTWITCHTitle = "Twitch sayfasına bağlantı",
   linkFBShow = "Fan Sayfasının bağlantısını görüntülemek için tıklayın",
   linkFBTitle = "Fan Sayfasına bağlantı",
   linkCloseFrame = "Çerçeveyi kapat",
   linkCopy = "Adresi panoya kopyalamak için Ctrl+C tuşlarına basın",                                 -- Press Ctrl+C to copy the address to the clipboard (TR:Buraya tıklayıp Ctrl+A tuşlarına ardından kopyalamak için Ctrl+C tuşlarına basın)
   betaTestersHeader = "TÜRKÇE ÇEVİRİ TAKIMI",                                                        -- TRANSLATION TEAM (TR:TÜRKÇE ÇEVİRİ TAKIMI)
   betaTestersHeaderDESC = "Hakan YILMAZ, Ramazan USLU, Totik Channel",                               -- Beta Testers:
};
