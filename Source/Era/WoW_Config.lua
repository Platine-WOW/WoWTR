...
-- Adjust the size and position of the frame (NOW STANDALONE)
-- WOWTR_OptionsHeader:SetFontObject(GameFontNormalLarge); -- Removed as we use custom header text
...
WOWTR_OptionPanel1:SetWidth(800); -- Adjusted (was 682)
WOWTR_OptionPanel1:SetHeight(530);
WOWTR_OptionPanel1:ClearAllPoints();
WOWTR_OptionPanel1:SetPoint("TOPLEFT", WOWTR_Options, "TOPLEFT", 190, -80); -- Shifted Right (was -15, -73)
...
if (WoWTR_Localization.lang == 'AR') then
   WOWTR_Panel1Header2:SetPoint("TOPLEFT", WOWTR_OptionPanel1, "TOPLEFT", 580, -310);
else
   WOWTR_Panel1Header2:SetPoint("TOPLEFT", WOWTR_OptionPanel1, "TOPLEFT", 20, -310);
end
...
WOWTR_CheckButton46.Text:SetText("|cff808080"..QTR_ReverseIfAR(WoWTR_Config_Interface.displayTranslationUI3).."|r");   -- Display translation of user interface (Group Finder)
...
WOWTR_CheckButton50.Text:SetText("|cff808080"..QTR_ReverseIfAR(WoWTR_Config_Interface.displayTranslationUI7).."|r");   -- Display translation of user interface (Group Finder)
...
WOWTR_CheckButton47.Text:SetText("|cff808080"..QTR_ReverseIfAR(WoWTR_Config_Interface.displayTranslationUI4).."|r");   -- Display translation of user interface (Collections Frame)
...
WOWTR_CheckButton48.Text:SetText("|cff808080"..QTR_ReverseIfAR(WoWTR_Config_Interface.displayTranslationUI5).."|r");   -- Display translation of user interface (Advanture Guide)
...
if (WoWTR_Localization.lang == 'AR') then
   ...
   WOWTR_ResetButton2:SetPoint("TOPLEFT", WOWTR_Panel4Header1, "TOPLEFT", 449, -470);
end
